...
TITLES = {
    ...
    "part2": "Basic Tools",
    "part2memory": "Basic Tools (Memory + tools)",
    "part2memguardrails": "Basic Tools (Memory + tools + Guardrails)",
    "part3": "Memory",
}
...
DESCRIPTIONS = {
    ...
    "part2memguardrails": "Your intelligent AI assistant that can answer questions, perform calculations, and maintain conversation context.",
